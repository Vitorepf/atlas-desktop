 ...
 *
 * Cobre 4 famílias: YouTube, Vimeo, GitHub, generic web. Para cada uma tenta
 * enriquecer com título/autor/thumbnail/duração via oEmbed público (sem API
 * key). Em network failure cai pro modo 'generic' com só o URL parseado.
 *
 * Esta capability é compartilhada — Atlas AI, Forge/Obras, Dev ou Mobile
 * podem importar daqui sem cópia local.
 */
